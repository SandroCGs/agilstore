...
| GET | /produtos/buscar?nome= | Buscar produtos por parte do nome |
...
- Se um produto não for encontrado por ID ou nome, a API retorna um erro NotFoundException com mensagem apropriada.
